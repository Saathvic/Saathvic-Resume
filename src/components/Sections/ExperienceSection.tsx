...
const experiences = [
	{
		...
		description:
			"Worked on real-world GenAI problems using LLaMA and LangChain. Involved in prompt engineering and model integration for sustainability-focused use cases.",
	},
	{
		...
		description:
			"Developed AI-based backend solutions to optimize client business operations. Contributed to scalable architecture and smart system integration.",
	},
];
...
const educations = [
	{
		...
		period: "2022 - Present",
		description:
			"GPA: 8.24. Participated in national-level hackathons. Specialized in AI, AR, and accessibility-based technologies.",
	},
	{
		...
		period: "2021 - 2022",
		description:
			"Score: 84.4%. Computer Science stream. Developed early tech interest and mini projects.",
	},
	{
		title: "High School",
		company: "Achariya Bala Siksha Mandir",
...
const TimelineItem = ({
	...
	return (
		<div
			className={`mb-8 sm:mb-12 flex justify-between items-start ${
		...
		>
			...
			>
				...
				<p className="flex items-center text-white/70 text-xs sm:text-sm mb-2 gap-1 justify-end">
			...
			<div className="relative z-10">
				...
				<div className="absolute top-8 sm:top-10 bottom-0 left-1/2 w-1 bg-primary/20 -translate-x-1/2" />
			</div>
			...
			>
				<div className="md:hidden mb-2">
					<h3 className="text-lg sm:text-xl font-bold">{item.title}</h3>
					<p className="text-primary mb-1">{item.company}</p>
					<p className="flex items-center text-white/70 text-xs sm:text-sm mb-2 gap-1">
						<CalendarDays className="h-3 sm:h-4 w-3 sm:w-4" />
						{item.period}
					</p>
				</div>
		...
		<section id="experience" className="section bg-background">
			<div className="container mx-auto">
				...
				<div className="relative mb-16 sm:mb-20">
					<h3 className="text-xl sm:text-2xl font-bold mb-8 sm:mb-10 text-center">
				...
				<div>
					...
					<div className="grid grid-cols-1 landscape:grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
